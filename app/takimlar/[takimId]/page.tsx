      ...
      <section className="border-b border-white/10 bg-gradient-to-b from-slate-900/60 to-transparent">
        <Container className="py-8">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <Link
              href={`/duvar-kagidi/?team=${team.id}`}
              className="inline-flex min-h-[2.75rem] items-center gap-1.5 rounded-lg border border-white/15 bg-white/[0.04] px-3 py-1.5 text-xs font-medium text-slate-200 transition-colors hover:text-white"
            >
              📱 Duvar kağıdı
            </Link>
            {matches.length > 0 && (
